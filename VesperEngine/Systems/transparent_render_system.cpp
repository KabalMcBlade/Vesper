...
// File: C:\Projects\Vesper\VesperEngine\Systems\transparent_render_system.cpp
...
void TransparentRenderSystem::MaterialBinding()
{
    ...
    for (auto gameEntity : ecs::IterateEntitiesWithAll<PipelineTransparentComponent>(entityManager, componentManager))
	{
